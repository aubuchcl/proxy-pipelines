...
* **environment secrets:** add in update and remove functions ([be540db](https://github.com/cycleplatform/api-client-nodejs/commit/be540dba590c78a25bafe5a1f23b7169bcee11fb))
