export declare type Origin = OriginBase<"docker-file"> | OriginBase<"docker-hub"> | OriginBase<"docker-registry">;
...
export declare type AllOriginsKeys = keyof AllOrigins;
/****************************** Sources ******************************/
...
export declare type Dockerfile = DockerfileWithRepo | DockerfileWithTar;
...
export declare type RepoAuth = RepoAuthBase<"http"> | RepoAuthBase<"ssh">;
...
export declare type AllAuthTypeKeys = keyof AllAuthTypesMap;
