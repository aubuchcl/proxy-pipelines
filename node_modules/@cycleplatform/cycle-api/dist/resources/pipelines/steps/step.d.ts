 ...
 */
export declare type Step = Base<"sleep"> | Base<"webhook.post"> | Base<"container.create"> | Base<"container.reimage"> | Base<"container.restart"> | Base<"container.start"> | Base<"container.stop"> | Base<"container.delete"> | Base<"image.source.create"> | Base<"image.create"> | Base<"image.import"> | Base<"images.prune"> | Base<"environment.create"> | Base<"environment.start"> | Base<"environment.stop"> | Base<"environment.delete"> | Base<"stack.build.create"> | Base<"stack.build.generate"> | Base<"stack.build.deploy">;
/** ### `interface Base<T>`
 ...
 * Last Updated: 2021.01.26 — Grady S
 */
export declare type AllActionsMap = {
    sleep: Other.Sleep;
 ...
 * Last Updated: 2021.01.26 — Grady S
 */
export declare type AllActionKeys = keyof AllActionsMap;
